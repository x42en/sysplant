...
from tests.fixtures import rust_output
from sysplant.managers.rustGenerator import RustGenerator


class TestRustGenerator(unittest.TestCase):
    ...
    def test_01_generate_struct(self):
        ...
        self.assertEqual(result, rust_output.structure)
    ...
    def test_01_generate_struct3(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.structure3)
    ...
    def test_02_generate_union(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.union)
    ...
    def test_03_generate_pointer(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.pointer)
    ...
    def test_04_generate_standard(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.standard)
    ...
    def test_05_generate_enum(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.enum)
    ...
    def test_06_generate_debug(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.debug)
    ...
    def test_07_generate_seed(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.seed)
    ...
    def test_08_generate_stub(self):
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.stub)

    def test_09_generate_definitions(self):
        klass = RustGenerator()
        params = dict(
            {
                "type": "NTSTATUS",
        ...
        self.assertEqual(type(result), str)
        self.assertEqual(result, rust_output.definitions)
