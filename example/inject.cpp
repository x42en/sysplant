/*
    ...
    This file require mingw C++ compiler to be installed
        apt install mingw-w64

    Compile it on linux using:
        x86_64-w64-mingw32-g++ -Wall -s -static -masm=intel inject.cpp -o inject.exe
*/

#include <windows.h>
#include <cstring>

// Ensure syscall.hpp is generated next to this file
#include "syscall.hpp"
