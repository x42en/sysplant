...
#endif
#ifndef IO_STATUS_BLOCK_UNION
typedef union _IO_STATUS_BLOCK_UNION
{
    LONG Status;
    PVOID Pointer;
} IO_STATUS_BLOCK_UNION, *PIO_STATUS_BLOCK_UNION;
#endif
#ifndef IO_STATUS_BLOCK
typedef struct _IO_STATUS_BLOCK
{
    IO_STATUS_BLOCK_UNION u1;
    ULONG Information;
